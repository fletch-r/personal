    ...
    return (
        <section className="w-full mb-14 md:mb-24">
            ...
            <div className="w-full flex gap-6 mb-6 flex-col md:flex-row slide-up-30">
                <a href="/content-editor" className="flex flex-1 justify-between gap-2 flex-col bg-oxford-main/10 hover:bg-green-600/10 p-4 rounded-lg invisible animate-slide-up-1">
                ...
                <a href="/prism" className="flex flex-1 justify-between gap-2 flex-col bg-oxford-main/10 hover:bg-blue-600/10 p-4 rounded-lg invisible animate-slide-up-1">
                    <div className='flex flex-col gap-2'>
