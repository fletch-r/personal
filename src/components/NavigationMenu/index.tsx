...
const ListItem = React.forwardRef(({ className, children, title, ...props }: { className?: string; children: React.ReactNode; title: string; href: string; }, forwardedRef: React.LegacyRef<HTMLAnchorElement>) => (
    <li>
