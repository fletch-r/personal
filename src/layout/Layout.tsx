        ...
        <>
            ...
            <footer className='max-w-[1000px] mx-auto border-t border-steal-100 dark:border-oxford-main px-4 py-4 flex justify-between items-center'>
                ...
                <div className='flex gap-8'>
                    <a href="https://www.twitter.com/httpfleck" className="hover:bg-steal-300 rounded-full px-2 py-2 transition-all hover:bg-opacity-20 flex justify-center items-center">
                        <TwitterIcon />
                    </a>
                    <a href="https://uk.linkedin.com/in/andrew-fletcher-3009" className="hover:bg-steal-300 rounded-full px-2 py-2 transition-all hover:bg-opacity-20 flex justify-center items-center">
                        <LinkedInIcon />
                    </a>
                    <a href="https://github.com/0xATHERIS" className="hover:bg-steal-300 rounded-full px-2 py-2 transition-all hover:bg-opacity-20 flex justify-center items-center">
                        <GitHubIcon />
                    </a>
                </div>
            </footer>
